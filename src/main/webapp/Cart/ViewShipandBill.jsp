    ...
    <head>
        ...
        <div class="container">
            ...
            <form action="?updateAddress=true" method="post">
                ...
                <input type="text" class="form-control" name="shipto"  value="${object.getShipTo()}" ><br><button class="btn btn-success" type="submit">Update</button><br><br>
                <h5>Billing Address</h5>
                <input type="text" class="form-control" name="billto"  value="${object.getBillTo()}"><br><button class="btn btn-success" type="submit">Update</button><br><br>
